  ...
  <div class="flex-1 flex flex-col bg-white overflow-hidden">
    ...
    <div class="border-b flex px-6 py-2 items-center flex-none">
        ...
        <div class="flex-1 justify-center hidden sm:flex">
          <!--<v-suggest :data="animesByGenre" type="text" placeholder="Search Anime ..." show-field="title" v-model="searchModel" class="border border-grey px-8 py-2 w-1/2 max-w-md outline-none rounded-l"></v-suggest> -->
